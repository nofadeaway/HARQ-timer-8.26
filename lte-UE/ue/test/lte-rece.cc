...
{
	struct timeval tti_timeout={0,300000};    //用于测试，recv超时
	...
	setsockopt(st,SOL_SOCKET,SO_RCVTIMEO,(char *)&tti_timeout,sizeof(struct timeval));  //FX:8.24
	setsockopt(st_a,SOL_SOCKET,SO_RCVTIMEO,(char *)&tti_timeout,sizeof(struct timeval));  //FX:8.24
	setsockopt(st_DCI,SOL_SOCKET,SO_RCVTIMEO,(char *)&tti_timeout,sizeof(struct timeval));  //FX:8.24
